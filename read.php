    ...
    <div class="row no-gutters">
        ...
        <div class="col-md-7 bordeB ">
            ...
            <div class="followingList">
                ...
                if (!$db->query("SELECT u.idCom,estado,imagen,nombre FROM comic c INNER JOIN usu_comic u ON c.idCom=u.idCom WHERE idUsu LIKE ? AND estado LIKE ?", [$usr->getIdUsu(), "READ"])) {
                    echo "No comic has been read";
                } else {
                    // Obtenemos el numero de comics 
                    $total  = $db->getNumRows();
                    ?> <h3 class="mb-5">READ: <?php echo $total ?> </h3>
                    <?php
                        do {
                            ?>
                        <div class="row mb-2">
